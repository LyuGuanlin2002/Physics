...
%\addtocontents{toc}{\protect\begin{minipage}{2\linewidth/3}}
\chapter{附录}
%\begin{tikzpicture}[overlay,remember picture]
%	\draw(current page text area.south east)rectangle(current page text area.north west);
%\end{tikzpicture}
\lipsum[1]
%\zhlipsum
...
\begin{Definition}[测试文字\footnote{测试脚注}]
	测试文字\footnote{脚注}
	\begin{flalign}
		\Psi=\int_\Omega\left[f\left(\phi\right)+\kappa\left|\nabla\phi\right|^2\right]{\rm d}V
	\end{flalign}
