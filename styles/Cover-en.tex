...
%%标题%%
\node[font=\FontSizeSet{40pt}{48pt}\bfseries\sffamily,coverup node](T)at(current page text area.north west){\@title};
%%副标题%%
\node[font=\FontSizeSet{30pt}{36pt}\bfseries\sffamily,coverup node](ST)at([yshift=-1.5cm]T.south west){\ifdefvoid{\@subtitle}{}{\@subtitle}};
%%作者%%
\node[font=\FontSizeSet{15pt}{18pt}\bfseries\sffamily,coverdown node](A)at([yshift=4.0cm]current page text area.west){Editor\quad\@author};
%%出版社%%
...
%%书籍系列%%
\node[font=\FontSizeSet{15pt}{18pt}\bfseries\sffamily,backdown node](V)at([yshift=-0.5cm]S.south west){\ifdefvoid{\@version}{}{Version~~{\@version}}};
\end{tikzpicture}
\end{titlepage}}
